...
5. Launcher 的“书库”和“相册”标题使用 24px 固化字形，并在 70px 卡片内
   保持清晰的标题/说明层级。
...
生成器增加 24px 的“书库”和“相册”固化短语，替换当前 12px 资产。页面标题
...
- 固化资产包含 24px“书库/相册”，生成结果与仓库文件一致。
- Launcher 卡片自检验证 24px 标题实际落点和文字组边界。
