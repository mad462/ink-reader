...
typedef enum {
    ...
    INK_APP_EVENT_BUTTON_SNAPSHOT,
    INK_APP_EVENT_NAV_PREVIOUS,
    INK_APP_EVENT_NAV_NEXT,
    INK_APP_EVENT_TILT_PREVIOUS,
    INK_APP_EVENT_TILT_NEXT,
    INK_APP_EVENT_TILT_UP,
    INK_APP_EVENT_TILT_DOWN,
    INK_APP_EVENT_TILT_UP_LEFT,
    INK_APP_EVENT_TILT_UP_RIGHT,
    INK_APP_EVENT_TILT_DOWN_LEFT,
    INK_APP_EVENT_TILT_DOWN_RIGHT,
